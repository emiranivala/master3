...
async def generate_session(_, message):
    ...
    try:
        ...
        await message.reply(f"❌ Failed to send ➡️ OTP 🗨️ {e}. Please wait 🫷 and try again later.")
    try:
        ...
        return
    try:
        otp_code = await _.ask(user_id, "Please check for an OTP 🗨️ in your official Telegram account. Once received, enter the OTP in the following format: \nIf the OTP is `12345`, please enter it as `1 2 3 4 5`.", filters=filters.text, timeout=600)
    except TimeoutError:
